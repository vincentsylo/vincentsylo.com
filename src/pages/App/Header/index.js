  ...
  render() {
    ...
    return (
      <header className={styles.header}>
        ...
        <Link to="/" className={cx(styles.largeOnly, styles.title)} onClick={this.onCloseNav}>vincentsylo</Link>
        ...
        <nav className={cx(styles.links, {
          ...
          <SocialLinks />
          <Link to="/services" className={styles.link} onClick={this.onCloseNav}>services</Link>
